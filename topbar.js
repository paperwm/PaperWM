    ...
    _onEvent(actor, event) {
        ...
        if (this.state === 'SMOOTH' && type === Clutter.EventType.SCROLL
            ...
            if (dy > 0
                ...
                && ((this.selected.actor.y > 0.45*active.height &&
                     this.selected.actor.y - dy < 0.45*active.height)
                    ||
                ...
                Tweener.addTween(this.selected.actor,
                       ...
                       && ((this.selected.actor.y < 0.55*active.height &&
                            this.selected.actor.y - dy > 0.55*active.height)
                           ||
